          ...
          <div className="relative">
            <Container className="">
              <div className="header">
                <Link href="/">
                  {" "}
                  <h3 className="text-4xl font-bold"> TechZon </h3>
                </Link>
                ...
                <div className="search">
                  <input
                    type="text"
                    placeholder="Search in TechZon"
                    autoComplete="off"
                  />
                  <button className="searchIconWrap">
            ...
            <nav
              className={toggleMenu ? `nav shadow-lg ` : `activeNav shadow-lg`}
            >
              <div className="flex items-center justify-between pr-5">
                <Link href="/">
                  {" "}
                  <h3 className="text-4xl font-bold mb-3"> TechZon </h3>
                </Link>
                <HiOutlineX
